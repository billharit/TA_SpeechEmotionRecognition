...
train_data_value = np.load(
    './processed_data/13_1024_512train_data_value_default.npy')
train_data_target = np.load(
    './processed_data/13_1024_512train_data_target_default.npy')
test_data_value = np.load(
    './processed_data/13_1024_512test_data_value_default.npy')
test_data_target = np.load(
    './processed_data/13_1024_512test_data_target_default.npy')
print(train_data_value.shape[1])
...
history = model.fit(train_data_value, train_data_target, validation_data=(
    test_data_value, test_data_target), batch_size=32, epochs=50)
...
# np.save("40_1024_512train_data_value_default", train_data_value)
# np.save("40_1024_512train_data_target_default", train_data_target)
# np.save("40_1024_512test_data_value_default", test_data_value)
# np.save("40_1024_512test_data_target_default", test_data_target)

# train_data_value = np.load('40_1024_512train_data_value_default.npy')
# train_data_target = np.load('40_1024_512train_data_target_default.npy')
# test_data_value = np.load('40_1024_512test_data_value_default.npy')
# test_data_target = np.load('40_1024_512test_data_target_default.npy')

# x = train_cnn(train_data_value, train_data_target,
#               test_data_value, test_data_target, './logs/3-Block-CNN-Default    DataMFCC40FFT2048Hop512')
#
# train_data_value, train_data_target, test_data_value, test_data_target = turn_into_data_for_model(
#     train_df, test_df, 13, 2048, 512)
#
# np.save("13_1024_512train_data_value_default", train_data_value)
# np.save("13_1024_512train_data_target_default", train_data_target)
# np.save("13_1024_512test_data_value_default", test_data_value)
# np.save("13_1024_512test_data_target_default", test_data_target)
